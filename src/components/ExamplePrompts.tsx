    ...
    <section className="mx-auto w-full max-w-7xl px-5 pb-16">
      <div className="mb-6 flex items-end justify-between gap-4">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold text-zinc-100">从一个样板 brief 开始</h2>
        </div>
      </div>
      <div className="grid gap-4 md:grid-cols-3">
        {examplePrompts.map((example) => (
          <button
            ...
            className="quiet-panel p-5 text-left transition hover:border-cyan-100/25 hover:bg-white/[0.04]"
          >
