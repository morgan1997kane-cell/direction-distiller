    ...
    <aside className="quiet-panel p-5 lg:sticky lg:top-6">
      <div className="mb-6 flex items-start justify-between gap-3">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-medium text-zinc-100">项目归档</h2>
      ...
      <div className="space-y-3 border-t border-white/10 pt-4">
        <input
          ...
          className="w-full border border-white/10 bg-black/[0.16] px-3 py-2.5 text-sm text-zinc-100 outline-none placeholder:text-zinc-600 focus:border-cyan-100/30"
        />
          ...
          {filters.map((item) => (
            <button
              ...
              className={[
                ...
                filter === item.value
                  ? "border-cyan-100/28 bg-cyan-100/[0.07] text-cyan-50"
                  : "border-white/10 bg-white/[0.022] text-zinc-500 hover:text-zinc-200",
              ].join(" ")}
            >
              {item.label}
            </button>
                  ...
                  {editingId === item.id ? (
                    <div className="flex gap-2">
                      <input
                        ...
                        className="min-w-0 flex-1 border border-white/10 bg-black/40 px-2 py-1 text-sm text-zinc-100 outline-none focus:border-cyan-100/35"
                      />
